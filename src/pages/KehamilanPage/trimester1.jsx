  ...
  return (
    ...
    <Navigation />
      <div className='box-content-trimester'>
        ...
        <div className='desc-trimester-123'>
          <h4> Pengertian Trimester Pertama Kehamilan </h4>
        ...
        <div className='desc-trimester-123'>
          ...
          <ul>
            ...
            <li>Pembuluh Darah Vena Terlihat</li>
              <p>Perubahan ini terjadi akibat peningkatan volume darah, sehingga jantung memompa darah lebih cepat untuk memenuhi kebutuhan selama kehamilan. Pembuluh darah vena yang berwarna biru bisa terlihat di perut yang membesar dan area payudara. Sementara pembuluh darah yang tampak seperti laba-laba bisa muncul di kaki, wajah, dan lengan. Pada kasus tertentu, pembuluh darah vena membesar tampak di kaki (varises).</p>
        ...
        <div className='desc-trimester-123'>
          ...
          <li>Sembelit</li>
          <p>Konstipasi merupakan masalah yang dialami oleh sekitar 70 persen ibu hamil. Penyebabnya yaitu pergerakan usus yang menjadi lebih lambat dari biasanya saat hamil. Sebab, makanan terlalu lama berada di dalam usus akan meningkatkan risiko terjadinya konstipasi.</p>
          </ul>
          </div>
          ...
          <p>Umumnya, ibu hamil perlu mengonsumsi air putih sebanyak 8-10 gelas dalam satu hari, bahkan bisa lebih. Ini disebabkan karena tubuh memerlukan cairan lebih banyak saat hamil untuk membantu pertumbuhan dan perkembangan bayi dalam kandungan. Selain itu, konsumsi cukup air putih dapat menghindari ibu dari berbagai masalah yang rentan terjadi pada air ketuban. Sebab, air ketuban yang terlalu sedikit atau terlalu banyak memberikan dampak yang kurang baik untuk janin.</p>
          <li>Cukup Istirahat</li>
          <p>Jangan lupa untuk memenuhi kebutuhan istirahat selama kehamilan, terlebih di semester pertama. Sebab, perubahan tubuh dan mental ibu turut memberikan pengaruh terhadap waktu istirahat. Saat menjalani kehamilan di trimester pertama, ibu perlu memenuhi waktu istirahat yang sesuai dengan kebutuhan dan tambahan istirahat pada siang atau sore hari. Waktu istirahat yang terpenuhi dengan baik memberikan dampak positif terhadap kesehatan ibu dan janin selama masa kehamilan. Selain itu, cukup istirahat juga membantu ibu lebih mudah mengontrol emosi yang mengalami perubahan saat kehamilan.</p>
          <li>Rutin Olahraga</li>
          <p>Meski sedang hamil, sebaiknya ibu tidak lupa untuk tetap rutin berolahraga. Namun, perlu diingat bahwa jenis olahraga yang bisa dilakukan tidak sembarangan, begitu pula durasinya. Lakukan olahraga ringan seperti berjalan kaki dengan durasi sekitar 30 menit setiap harinya. </p>
          <li>Menghindari Stres</li>
          <p>Stres tidak hanya berdampak negatif untuk kesehatan ibu, tetapi juga perkembangan kehamilan. Bahkan, stres yang tidak ditangani bisa membuat ibu hamil mengalami keguguran. Segera hubungi dokter jika mengalami gejala atau gangguan kesehatan selama kehamilan. Penanganan yang tepat dan cepat dapat mengurangi risiko terjadinya komplikasi.</p>
          </ul>
          </div>

        <div className='container-usia-janin'>
          <div className='judul-usia-janin'>
            <p>Ketahui info lebih lanjut tentang perkembangan janin sesuai usia kehamilan ini:</p>
            <ul>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-1-minggu' target="_blank" rel="noreferrer">Janin usia 1 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-2-minggu' target="_blank" rel="noreferrer">Janin usia 2 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-3-minggu' target="_blank" rel="noreferrer">Janin usia 3 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-4-minggu' target="_blank" rel="noreferrer">Janin usia 4 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-5-minggu' target="_blank" rel="noreferrer">Janin usia 5 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-6-minggu' target="_blank" rel="noreferrer">Janin usia 6 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-7-minggu' target="_blank" rel="noreferrer">Janin usia 7 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-8-minggu' target="_blank" rel="noreferrer">Janin usia 8 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-9-minggu' target="_blank" rel="noreferrer">Janin usia 9 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-10-minggu' target="_blank" rel="noreferrer">Janin usia 10 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-11-minggu' target="_blank" rel="noreferrer">Janin usia 11 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-12-minggu' target="_blank" rel="noreferrer">Janin usia 12 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-13-minggu' target="_blank" rel="noreferrer">Janin usia 13 Minggu</a>
              </li>
            </ul>
          </div>
        </div>
