    ...
    <>
      ...
      <div className='box-content-trimester'>
        ...
        <div className='desc-trimester-123'>
          <h4>Pengertian Trimester Kedua Kehamilan</h4>
        ...
        <div className='desc-trimester-123'>
          ...
          <p>Jika ibu khawatir tentang perasaan cemas, suasana hati yang buruk, atau depresi, pastikan ibu memeriksakan kondisi ke psikolog atau dokter kandungan. </p>
        </div>
        ...
        <div className='desc-trimester-123'>
          <h4>Kebutuhan Nutrisi saat Trimester Kedua</h4>
          <p>Memenuhi nutrisi yang sehat dan seimbang sangat penting untuk dilakukan selama kehamilan. Sebab, hal ini dapat membantu perkembangan bayi serta menjaga kesehatan ibu hamil. Itulah mengapa ibu hamil dianjurkan memasak makanan sendiri di rumah agar terjamin kualitas dan kebersihan makanan.</p>
          <p>Beberapa asupan makanan yang penting untuk dipenuhi selama kehamilan adalah makanan yang mengandung tinggi serat seperti yang ditemukan pada buah atau sayuran, protein, dan rendah lemak.</p>
          <p>Selain makanan berserat, ibu perlu memenuhi asupan cairan untuk menghindari risiko sembelit. Dan yang tak kalah pentingnya, multivitamin prenatal juga diperlukan untuk memastikan ibu hamil memenuhi semua kebutuhan vitamin dan mineral selama kehamilan. </p>
        </div>
        ...
        <div className='container-usia-janin'>
          <div className='judul-usia-janin'>
            ...
            <ul>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-14-minggu' target="_blank" rel="noreferrer">Janin usia 14 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-15-minggu' target="_blank" rel="noreferrer">Janin usia 15 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-16-minggu' target="_blank" rel="noreferrer">Janin usia 16 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-17-minggu' target="_blank" rel="noreferrer">Janin usia 17 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-18-minggu' target="_blank" rel="noreferrer">Janin usia 18 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-19-minggu' target="_blank" rel="noreferrer">Janin usia 19 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-20-minggu' target="_blank" rel="noreferrer">Janin usia 20 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-21-minggu' target="_blank" rel="noreferrer">Janin usia 21 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-22-minggu' target="_blank" rel="noreferrer">Janin usia 22 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/begini-perkembangan-janin-pada-usia-23-minggu' target="_blank" rel="noreferrer">Janin usia 23 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/begini-perkembangan-janin-pada-usia-24-minggu' target="_blank" rel="noreferrer">Janin usia 24 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/begini-perkembangan-janin-pada-usia-25-minggu' target="_blank" rel="noreferrer">Janin usia 25 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/begini-perkembangan-janin-pada-usia-26-minggu' target="_blank" rel="noreferrer">Janin usia 26 Minggu</a>
              </li>
            </ul>
          </div>
        </div>
