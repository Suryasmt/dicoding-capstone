  ...
  return (
    ...
    <div className='box-content-trimester'>
      ...
      <div className='desc-trimester-123'>
        <h4>Pengertian Kehamilan Trimester Ketiga</h4>
      ...
      <div className='desc-trimester-123'>
        <h4>Menjaga Kesehatan Tubuh saat Kehamilan Trimester Ketiga</h4>
        <p>Kenaikan berat badan adalah hal yang normal dari kehamilan dan kebanyakan ibu hamil mengalami kenaikan berat badan sebanyak 11 hingga 16 kilogram. Gunakan kalkulator penambahan berat badan kehamilan agar ibu dapat melacak kenaikan berat badan selama trimester ketiga</p>
        <p>Selain itu, cobalah untuk tetap aktif selama kehamilan trimester ketiga. Rutinlah berolahraga yang direkomendasikan dokter untuk ibu hamil sebelum persalinan. Olahraga diperlukan agar ibu memiliki stamina yang baik saat melewati proses persalinan.</p>
      </div>
      ...
      <div className='container-usia-janin'>
          <div className='judul-usia-janin'>
            ...
            <ul>
              <li>
                <a href='https://www.halodoc.com/artikel/begini-perkembangan-janin-usia-27-minggu' target="_blank" rel="noreferrer">Janin usia 27 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/begini-perkembangan-janin-pada-usia-28-minggu' target="_blank" rel="noreferrer">Janin usia 28 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/begini-perkembangan-janin-pada-usia-29-minggu' target="_blank" rel="noreferrer">Janin usia 29 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/begini-perkembangan-janin-pada-usia-30-minggu' target="_blank" rel="noreferrer">Janin usia 30 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/begini-perkembangan-janin-pada-usia-31-minggu' target="_blank" rel="noreferrer">Janin usia 31 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-32-minggu' target="_blank" rel="noreferrer">Janin usia 32 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-33-minggu' target="_blank" rel="noreferrer">Janin usia 33 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-34-minggu' target="_blank" rel="noreferrer">Janin usia 34 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-35-minggu' target="_blank" rel="noreferrer">Janin usia 35 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-36-minggu' target="_blank" rel="noreferrer">Janin usia 36 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-37-minggu' target="_blank" rel="noreferrer">Janin usia 37 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-38-minggu' target="_blank" rel="noreferrer">Janin usia 38 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-39-minggu' target="_blank" rel="noreferrer">Janin usia 39 Minggu</a>
              </li>
              <li>
                <a href='https://www.halodoc.com/artikel/perkembangan-janin-usia-40-minggu' target="_blank" rel="noreferrer">Janin usia 40 Minggu</a>
              </li>
            </ul>
          </div>
        </div>
